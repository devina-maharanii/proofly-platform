...
const HERO_ATLAS = "/manus-storage/proofly-hero-evidence-atlas_5f352860.jpg";
const REVIEW_FIELD = "/manus-storage/proofly-review-field_2fece006.jpg";
const TRUST_TOPOGRAPHY = "/manus-storage/proofly-trust-topography_ebce8c82.jpg";
    ...
    <main id="top" className="site-root">
      ...
      <section className="hero page-shell">
        <div className="hero-copy">
          <Reveal>
            <SectionEyebrow number="01">Real work, made legible</SectionEyebrow>
          </Reveal>
          <Reveal delay={0.04}>
            <h1>{homepageCopy.hero.headline}</h1>
          </Reveal>
          <Reveal delay={0.08}>
            <p className="hero-description">{homepageCopy.hero.description}</p>
          </Reveal>
      ...
      >
        ...
        <Reveal delay={0.07} className="problem-detail">
          <p>
            Early-career developers can have serious ability without an easy way
            to show the decisions behind their work. Teams can see activity,
            presentation, or credentials without enough context to make a fair
            human judgment.
          </p>
          <p>
            Proofly is designed to connect the work, its provenance, a
            transparent review, and an accountable next step—without pretending
            that one score can settle suitability.
          </p>
      ...
      >
        <div className="page-shell proof-grid">
          <Reveal className="proof-intro">
            ...
            <p>
              Every stage keeps the relevant person, source, and limit visible.
              The sequence is a product direction—not a promise of employment.
            </p>
          </Reveal>
      ...
      >
        <div className="page-shell company-layout">
          ...
          <Reveal delay={0.08} className="company-copy">
            ...
            <p>
              Define realistic work, see the review context around a submission,
              and keep your hiring judgment human. When the market and policy
              support it, a fair paid trial gives both parties a bounded way to
      ...
      >
        <Reveal className="verification-heading">
          ...
          <h2 id="verification-title">Trust is a chain people can inspect.</h2>
        </Reveal>
        <div className="verification-ledger">
          ...
          <Reveal delay={0.08} className="ledger-item">
            ...
            <div>
              ...
              <p>
                A reviewer works against a transparent rubric, with conflict and
                feedback context.
              </p>
            </div>
          </Reveal>
        ...
        <div className="page-shell trust-layout">
          <Reveal className="trust-copy">
            ...
            <p>
              ...
              are not public proof. Identity assurance, reviewer approval, work
              verification, payout eligibility, and hiring suitability remain
              separate signals.
            </p>
            <div className="trust-tags">
              <span>
                <LockKeyhole size={15} aria-hidden="true" /> Private by default
              </span>
              <span>
      ...
      >
        <Reveal className="final-card">
          ...
          <p className="final-note">
            Role-specific signup is a planned public route, not a live Phase 09
            behavior.
          </p>
        </Reveal>
      </section>
